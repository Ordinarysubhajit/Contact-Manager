...
const ContactForm = ({ action, contact }: ContactFormProps) => {
    ...
    return <form action={formAction} className='space-x-4'>
      ...
      <button
      type="submit"
      className='mt-3 w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus-outline'>
        Save Contact
        </button>
    </form>
}
